                ...
                <div className="z-10 relative w-full lg:w-[300px]">
                    <form onSubmit={handleSubmit} className="w-full px-[20px] lg:max-w-[300px] rounded-[5px] flex flex-col gap-y-[10px] bg-[#fff] p-4">
                        <div className="flex justify-center w-full">
                            <a className="text-black font-bold text-xl">Luxcraft Admin</a>
                        </div>
                        <div className="text-center">
                            <p className="text-[red] font-bold">{formError && formError}</p>
                        </div>
                        ...
                        <div className="w-full">
                            <button className={`${Loading ? "pointer-events-none" : ""} btn btn-primary w-full font-bold text-white`}>{Loading ? "Loading..." : "LOGIN"}</button>
                        </div>
                    </form>
                </div>
